...
describe FriendlyTime do
	...
	it 'answers with about 45 minutes ago' do
		expect(FriendlyTime::FriendlyTimeProvider.friendly_time(2700, 0)).to eql("about 45 minutes ago")
	end

	it 'answers with about an hour ago' do
		expect(FriendlyTime::FriendlyTimeProvider.friendly_time(3600, 0)).to eql("about an hour ago")
	end

	it 'answers with a couple of hours ago' do
		expect(FriendlyTime::FriendlyTimeProvider.friendly_time(7200, 0)).to eql("a couple of hours ago")
	end

	it 'answers with a few hours ago' do
		expect(FriendlyTime::FriendlyTimeProvider.friendly_time(14400, 0)).to eql("a few hours ago")
	end
